---
name: cleanup
description: "Use when: reviewing NovKorak project housekeeping, cleanup, stale TODOs, console.log statements, unused imports, orphaned files, context drift, env variable parity, current-feature history order, or stale @ts-ignore comments. Supports check-only mode and selective run/fix cleanup."
---
