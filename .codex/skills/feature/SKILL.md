---
name: feature
description: "Use when: managing the NovKorak current feature workflow with /feature load, start, test, review, explain, or complete. Tracks goals in context/current-feature.md, implements feature specs, reviews changed code, writes focused tests, explains changes, and completes branch/merge cleanup."
---

# Feature Workflow

Manage the lifecycle of one NovKorak feature from spec intake through implementation, validation, review, explanation, and completion.
